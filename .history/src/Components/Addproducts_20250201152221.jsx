      ...
      <form onSubmit={handleSubmit} className='space-y-4'>
        <div>
          ...
          <input
            ...
            className='w-full p-2 border bg-amber-50 rounded focus:ring-2 focus:ring-blue-500'
          />
        </div>
        ...
        <button
          type='submit'
          className='w-[30%] justify-center  bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 rounded transition'
        >
